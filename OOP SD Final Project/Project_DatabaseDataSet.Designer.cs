...
SELECT ShowTimeId, RoomId, MovieId, StartTime, TicketsSold FROM ShowTime WHERE (ShowTimeId = @ShowTimeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ShowTime.StartTime, Movie.Title, Room.RoomNo\r\nFROM            ShowT" +
                "ime INNER JOIN\r\n                         Room ON ShowTime.RoomId = Room.RoomId I" +
        ...
        public virtual int FillByClientsDisplay(Project_DatabaseDataSet.ShowTimeDataTable dataTable) {
        ...
        public virtual Project_DatabaseDataSet.ShowTimeDataTable GetDataByClientsDisplay() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Project_DatabaseDataSet.ShowTimeDataTable dataTable = new Project_DatabaseDataSet.ShowTimeDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
